...
if __name__ == "__main__":
    ...
    source_directory = r"Z:\R&D\Personal\JohnF\H3D_MAPPER-DATA\Varying Source Height Test Data - No Mask"
    csv_files = find_csv_files(source_directory)
    ic(csv_files)
    # Destination folder in the local repository
    destination_dir = r"C:\Users\10552\OneDrive - Redlen Technologies\Code\H3D-app-deploy\data\height_test_data" 
