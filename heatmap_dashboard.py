...
from Extract_module import ExtractModule, OrganizeData, extract_metadata
...
x_positions = organized_data.x_positions
y_positions = organized_data.y_positions
...
def update_spectrum_avg(test_counter, x_range, y_range):
    ...
    title_string = f"""Spectrum avg of all pixels,
    Avg total counts: {all_data_dict[test_counter]['avg_total_counts']},
    Sum total counts: {all_data_dict[test_counter]['sum_total_counts']}"""
    spectrum_avg_fig.update_layout(title=title_string)
...
def update_spectrum_pixel(test_counter, x_idx, y_idx, x_range, y_range):
    ...
    title_string = f"""Spectrum of pixel (x={x_idx}, y={y_idx}),
    Pixel total counts: {pixel_total_counts}"""
    spectrum_pixel_fig.update_layout(title=title_string)
            ...
            [
                ...
                dcc.Dropdown(
                    ...
                    options=[
                        ...
                        {"label": "Total Counts Normalized","value": "total_counts_normalized",},
                    ],
                    style={"width": "100%"},
                    value="total_counts",
                ),
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Div(id="spectrum-pixel-container"),
                            ],
                        ),
...
def update_dynamic_heatmaps(slider_value, heatmap_type):
    heatmap_container = [
        dcc.Graph(
            id=f"heatmap-plot-{slider_value}",
            style={
                "margin": "auto",
                "display": "block",
            },
...
@app.callback(
    [
        ...
        Output("spectrum-pixel-container", "children"),
    ],
    [
        Input("heatmap-slider", "value"),
...
def update_spectrum_plots(slider_value, x_idx, y_idx, x_range, y_range):
    avg_spectrum_container = [
        dcc.Graph(
            id=f"avg-spectrum-{slider_value}",
            style={
                "display": "block",
                "width": "80%",
            },
    ...
    spectrum_pixel_container = [
        dcc.Graph(
            id=f"spectrum-pixel-{slider_value}",
            style={
                "display": "block",
                "width": "80%",
            },
    ...
    return avg_spectrum_container, spectrum_pixel_container
